...
Counts of occurences of reference sequences in illumina files are located
in the `output/counts/ <counts/>`_ folder.

For reports on the filtering of illumina sequences using fastp, please the the
fastp-reports in html format located in the
`output/logs/fastp <logs/fastp>`_ folder.
